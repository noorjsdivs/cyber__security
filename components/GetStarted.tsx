...
const GetStarted = () => (
  <div className="w-[140px] h-[140px] rounded-full bg-transparent border-2 border-gray-300 p-[2px] cursor-pointer brightness-75 hover:brightness-100 duration-300 animate-pulse">
