...
const Hero = () => (
  <div className="max-w-screen-xl md:flex items-center justify-between xl:px-0 sm:px-16 px-6 mt-[60px] mb-[80px]">
    <div className="flex-1 flex justify-center items-start flex-col xl:px-0 sm:px-16 px-6">
      ...
      <p className="max-w-[470px] mt-5 text-dimWhite">
        ...
        understand the new era of technology in much better way.
      </p>
    </div>
    <div className="flex-1 flex justify-center items-center md:my-0 my-10 relative">
      <div className="w-[100%] h-[100%] z-[5] ">
        <Image src={RobotImg} />
